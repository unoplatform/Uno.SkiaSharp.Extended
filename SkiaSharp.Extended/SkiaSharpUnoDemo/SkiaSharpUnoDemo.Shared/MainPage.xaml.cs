	...
	public sealed partial class MainPage : Page, INotifyPropertyChanged
	{
		...
		public int Interpolation
		{
			...
			set
			{
				...
				PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(Interpolation)));
				interpolationCanvas.Invalidate();
			}
		}
		...
		private void OnAnimateClicked(object sender, object args)
		{
		...
		private void OnPaintingInterpolation(object sender, SKPaintSurfaceEventArgs e)
		{
			var surface = e.Surface;
			var canvas = surface.Canvas;
